...
// Package definition for layout api docs. This only *defines* the package- it does not yet
...
export const apiDocsPackage = new Package('layout-api-docs', dgeniPackageDeps);
